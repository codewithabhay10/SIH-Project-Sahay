...
export default function MagnifyingGlass() {
  ...
  const clonedContentRef = useRef<HTMLDivElement>(null);
  ...
  useEffect(() => {
    ...
    const updatePosition = (x: number, y: number) => {
      ...
      if (frameRef.current) {
        frameRef.current.style.transform = `translate3d(${
          x - magnifierSize / 2
        }px, ${y - magnifierSize / 2}px, 0)`;
      }

      if (magnifiedContentRef.current) {
        magnifiedContentRef.current.style.clipPath = `circle(${
          magnifierSize / 2 - 10
        }px at ${x}px ${y}px)`;
      }
  ...
  return (
    <>
      ...
      <button
        ...
        className={`magnifier-ui magnifying-glass-toggle fixed right-5 top-1/2 -translate-y-1/2 z-[10000] p-4 rounded-full shadow-lg transition-all duration-300 ${
          isActive
        ...
        <>
          ...
          <div
            ...
            style={{
              ...
              transform: `translate3d(${position.x - magnifierSize / 2}px, ${
      ...
      {isActive && (
        <style jsx global>{`
          ...
          body::before {
            ...
            pointer-events: none;
            z-index: 9998;
            clip-path: circle(${magnifierSize / 2 - 10}px at ${position.x}px ${
          position.y
        }px);
            background-image: 
              paint(magnify);
      ...
      {isActive && (
        <div
          ...
          style={{
            ...
            height: "100vh",
            zIndex: 9998,
            clipPath: `circle(${magnifierSize / 2 - 10}px at ${position.x}px ${
              position.y
            }px)`,
