...
interface LanguageSwitcherApiProps {
  onLanguageChange?: (language: string) => void;
}

export default function LanguageSwitcherApi({ onLanguageChange }: LanguageSwitcherApiProps) {
  ...
  const changeLanguage = (langCode: string) => {
    ...
    // Dispatch custom event for instant language change
  ...
  const getCurrentLanguageName = () => {
    return languages.find(lang => lang.code === currentLanguage)?.nativeName || 'English';
  };
